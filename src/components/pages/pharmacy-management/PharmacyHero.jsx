...
import PMSStatic from "@/components/pages/pharmacy-management/PMSStatic";
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid md:grid-cols-2 items-center gap-12">
        ...
        <div>
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-2xl leading-relaxed">
            Enterprise-grade Pharmacy Management orchestrated in one ecosystem. 
            Streamline operations, enhance customer experience, and grow your pharmacy 
            with intelligent inventory and billing automation.
          </p>
        ...
        {/* PMS Static Visualization Wrapper */}
