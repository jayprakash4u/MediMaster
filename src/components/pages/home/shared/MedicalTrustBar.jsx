  ...
  return (
    <div
      className={cn(
        ...
        isDark ? "justify-start lg:justify-start" : "justify-start",
        className
      )}
    >
      <span
        className={cn(
          "inline-flex shrink-0 items-center gap-1.5 rounded-full border px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] sm:tracking-[0.16em]",
          isDark
