...
export default function PolyclinicBenefitsSection() {
  const benefits = [
    "Streamlines multi-specialty clinic operations with centralized management",
    "Reduces patient wait times with optimized appointment scheduling",
    "Ensures coordinated care across departments with shared patient records",
    "Improves resource utilization with smart staff and room allocation",
    "Provides real-time visibility into clinic performance and revenue",
    "Minimizes administrative overhead with integrated billing and reporting",
    "Supports seamless referral management between specialists",
  ];
                ...
                <div className="relative aspect-[16/10] bg-white rounded-lg overflow-hidden border border-slate-800">
                  <div className="w-full h-full bg-slate-50 flex flex-col p-2 text-slate-800 font-sans text-xxs">
                    <img
                      ...
                      alt="Polyclinic Management Benefits"
