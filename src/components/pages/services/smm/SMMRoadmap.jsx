...
const leftSteps = [
  {
    ...
    desc: "Define social media goals, target audience, and platform selection",
  },
  {
    num: "02",
    title: "Audit & Analysis",
    desc: "Analyze current social presence and competitor strategies",
  },
  {
    num: "03",
    title: "Content Calendar",
    desc: "Create monthly content calendar with themes, topics, and posting schedule",
  },
  {
    num: "04",
    title: "Creative Assets",
    desc: "Design visual assets, write captions, and prepare multimedia content",
  },
];
...
const rightSteps = [
  {
    ...
    desc: "Publish content across platforms and begin community engagement",
  },
  {
    num: "06",
    title: "Monitoring",
    desc: "Track performance metrics, engagement, and audience growth",
  },
  {
    num: "07",
    title: "Optimization",
    desc: "Refine strategy based on analytics and improve content performance",
  },
  {
    num: "08",
    title: "Reporting",
    desc: "Generate performance reports and plan next-phase improvements",
  },
];
...
export default function SMMRoadmap() {
  ...
  const currentSteps = activeTab === "left" ? leftSteps : rightSteps;
    ...
    <section ref={sectionRef} className="relative bg-[#0d1b2a] py-14 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="md:hidden">
          <div className="flex gap-1 mb-4 bg-[#0f2236] p-1 rounded-full w-fit mx-auto">
            <button
