...
export default function PolyclinicOrbit() {
  return (
    <>
      <div
        style={{
      ...
      >
        <div style={{ position: "relative", width: 340, height: 340, overflow: "visible" }}>
          ...
          {[
            { icon: "🏥", lines: ["Multi-", "Specialty"],     bg: "#0D9488", angle: 0   },
            { icon: "📅", lines: ["Appointment", "Scheduling"],bg: "#06B6D4", angle: 45  },
            { icon: "👨‍⚕️", lines: ["Doctor", "Management"],   bg: "#3B66E2", angle: 90  },
            { icon: "💊", lines: ["Pharmacy", "Integration"], bg: "#254DC8", angle: 135 },
            { icon: "🧪", lines: ["Lab &", "Radiology"],      bg: "#14B8A6", angle: 180 },
            { icon: "💳", lines: ["Central", "Billing"],      bg: "#0891B2", angle: 225 },
            { icon: "📊", lines: ["Cross-", "Dept Reports"],  bg: "#3B66E2", angle: 270 },
            { icon: "📱", lines: ["Patient", "Portal"],       bg: "#254DC8", angle: 315 },
          ].map((mod) => (
            <div
              key={"oc-" + mod.angle}
              style={{
          ...
          {[
            { icon: "📋", lines: ["Patient", "Records"],    bg: "#14B8A6", angle: 45  },
            { icon: "🛏️", lines: ["Room &", "Bed Mgmt"],   bg: "#254DC8", angle: 135 },
            { icon: "👥", lines: ["Staff", "Rostering"],    bg: "#0D9488", angle: 225 },
            { icon: "📦", lines: ["Inventory", "Control"],  bg: "#3B66E2", angle: 315 },
          ].map((mod) => (
            <div
              key={"ic-" + mod.angle}
              style={{
