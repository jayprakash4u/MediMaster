  ...
  const stats = [
    {
      label: "TRUSTED DAILY",
      value: "3,000+",
      description: "Doctors actively using DocPulse daily",
    },
    {
      label: "DELIVERED CARE",
      value: "10M+",
      description: "Appointments & records managed every year",
    },
    {
      label: "ALWAYS ON",
      value: "99.9%",
      description: "Uptime SLA with under 4-hour support response",
    },
    {
      label: "PROVEN EXPERTISE",
      value: "13+",
      description: "Years building healthcare technology in India",
    },
