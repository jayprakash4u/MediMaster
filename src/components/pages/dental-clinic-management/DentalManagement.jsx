...
const features = [
  "Complete patient dental records and treatment history tracking",
  "Appointment scheduling with automated reminders and follow-ups",
  "Digital tooth charting and treatment plan management",
  "Inventory and lab work order tracking for dental supplies",
];
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-6 space-y-6 max-w-xl">
          ...
          <p className="text-slate-500 text-sm md:text-base leading-relaxed">
            The complete dental clinic can be managed by an inbuilt dental module.
            You can manage appointments, track treatments, digitize tooth charts, and
            manage inventory—all structured natively inside a single interface.
          </p>
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center w-full">
          ...
          <div className="relative w-full max-w-[540px] aspect-[4/3] rounded-2xl border-4 border-slate-100/80 bg-slate-50 shadow-2xl overflow-hidden group">
            <img
              ...
              alt="Dental Clinic Management Interface"
          ...
          <div className="absolute -bottom-6 -left-4 md:-left-8 bg-white border border-slate-100 rounded-2xl p-4 shadow-xl flex items-center gap-4 max-w-[220px] animate-bounce" style={{ animationDuration: "5s" }}>
            ...
            <div>
              <h4 className="text-xs font-black text-slate-800 uppercase tracking-wider leading-none">Faster Visits</h4>
              <p className="text-xxs text-slate-400 font-medium mt-1 leading-tight">Streamlined appointments & treatments.</p>
            </div>
          </div>
        </div>
      </div>
