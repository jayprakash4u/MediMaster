  ...
  const industries = [
    {
      ...
      image: "/medimaster industry focus/healthcare.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/banking and finance service.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/insurance.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/telecom.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/life science.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/media and entertenment.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/education and learning.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/human resources managment.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    },
    {
      ...
      image: "/medimaster industry focus/retail and ecommerce.jpg",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
