...
const contentTypes = [
  ...
  },
  {
    ...
    color: "aqua",
    image: "/services/content-writing/product copywriting.jpg",
    features: [
  ...
  },
  {
    ...
    color: "navy",
    image: "/services/content-writing/website copywriting.jpg",
    features: [
      "Homepage messaging",
      "Landing page copy",
      "About us pages",
  ...
  },
  {
    ...
    color: "aqua",
    image: "/services/content-writing/marketing copywritg.jpg",
    features: [
      "Ad campaign copy",
      "Email newsletters",
      "Sales page content",
    ...
    <section ref={sectionRef} className="relative bg-white py-16 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 max-w-2xl mx-auto">
          ...
          >
            Content <span className="text-teal-600">Services</span>
          </h2>
