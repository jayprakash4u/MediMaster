...
import { Check, Headset, Network, UserRound } from "lucide-react";

const targetPoints = [
  "Growing businesses needing structured support workflows",
  "IT teams managing internal and external support requests",
  "SaaS companies requiring customer success tracking",
  "Service providers wanting to improve response times",
];
...
export default function SupportTicketingTargetAudience() {
  const colorMap = {
    teal: {
    ...
    <section className="w-full bg-white py-16 px-6 md:px-12 font-sans select-none">
      <div className="max-w-7xl mx-auto space-y-12">
        <h2 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold tracking-tight leading-[1.12] text-slate-900">
          Who Is This <span className="text-navy-600">Support Ticketing System For?</span>
        </h2>
