        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          <div ref={contentRef} className="flex-1 max-w-2xl text-center lg:text-left">
            ...
            <div className="space-y-4">
              <p className="text-sm uppercase tracking-[0.35em] text-teal-300/80">Help Desk</p>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white">
                Support <span className="text-teal-300">Center</span>
              </h1>
              <p className="text-sm sm:text-base leading-7 text-slate-300">
                Have questions or running into technical roadblocks? Our dedicated team is here to
