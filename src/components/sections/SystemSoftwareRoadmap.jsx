...
const leftSteps = [
  { num: "01", title: "Requirements Analysis", desc: "Define technical specifications, performance needs, and system architecture requirements" },
  { num: "02", title: "Technology Selection", desc: "Choose the optimal tech stack, frameworks, and infrastructure for your system" },
  { num: "03", title: "System Architecture", desc: "Design scalable architecture with microservices, databases, and APIs" },
  { num: "04", title: "Development Setup", desc: "Configure development environment, version control, and CI/CD pipelines" },
];

const rightSteps = [
  { num: "05", title: "Module Development", desc: "Build system modules with clean code practices and thorough documentation" },
  { num: "06", title: "Integration Testing", desc: "Test module integration and ensure system-wide compatibility" },
  { num: "07", title: "Deployment", desc: "Deploy to production with monitoring and backup systems in place" },
  { num: "08", title: "Maintenance & Scaling", desc: "Ongoing support, performance tuning, and system scaling as needed" },
];
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-10">
          <div ref={subRef} className="inline-flex items-center gap-2 mb-3">
            <span className="w-7 h-px bg-[#2dd4bf]" /><span className="text-[10px] font-bold tracking-[.28em] text-[#2dd4bf] uppercase">System Software</span><span className="w-7 h-px bg-[#2dd4bf]" />
          </div>
          ...
          <p className="mt-2 text-[10px] font-semibold tracking-[.2em] text-slate-500 uppercase">Development Project</p>
        </div>
