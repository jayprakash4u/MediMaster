    ...
    <section ref={sectionRef} className="bg-white py-16 px-6 sm:px-12 lg:px-16 antialiased">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        {features.map((feature) => (
          <div
            key={feature.title}
            className="group bg-white rounded-2xl border-2 border-navy-950 p-8 flex flex-col gap-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out"
          >
            <div className="p-3 bg-teal-50 rounded-xl w-fit group-hover:bg-teal-100 group-hover:scale-105 transition-all duration-300">
              {feature.icon}
            </div>

            <div className="flex flex-col gap-2.5">
              <h3 className="text-base md:text-lg font-extrabold tracking-wide text-navy-950 uppercase group-hover:text-teal-600 transition-colors duration-200">
                {feature.title}
              </h3>
