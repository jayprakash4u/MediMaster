...
const leftSteps = [
  { num: "01", title: "Research & Discovery", desc: "User research, stakeholder interviews, and competitive analysis to understand requirements" },
  { num: "02", title: "User Personas", desc: "Create detailed user personas and journey maps to guide design decisions" },
  { num: "03", title: "Information Architecture", desc: "Structure content and define navigation flow for optimal user experience" },
  { num: "04", title: "Wireframing", desc: "Create low-fidelity wireframes to establish layout and interaction patterns" },
];

const rightSteps = [
  { num: "05", title: "UI Design", desc: "Design high-fidelity mockups and prototypes with your brand identity" },
  { num: "06", title: "Usability Testing", desc: "Test with real users and iterate based on feedback and insights" },
  { num: "07", title: "Design Handoff", desc: "Deliver design specs and assets to development team" },
  { num: "08", title: "Post-Launch Review", desc: "Analyze user behavior and optimize design based on real data" },
];
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-10">
          <div ref={subRef} className="inline-flex items-center gap-2 mb-3">
            <span className="w-7 h-px bg-[#2dd4bf]" /><span className="text-[10px] font-bold tracking-[.28em] text-[#2dd4bf] uppercase">UI/UX Design</span><span className="w-7 h-px bg-[#2dd4bf]" />
          </div>
          ...
          <p className="mt-2 text-[10px] font-semibold tracking-[.2em] text-slate-500 uppercase">User Experience Project</p>
        </div>
