...
const targetPoints = [
  "Hospitals managing large patient volumes across departments",
  "Clinics seeking centralized patient record management",
  "Specialty centers requiring coordinated care workflows",
  "Individual practitioners wanting streamlined patient journeys",
];
...
export default function PatientTargetAudience() {
  const colorMap = {
    teal: {
    ...
    <section className="w-full bg-white py-16 px-6 md:px-12 font-sans select-none">
      <div className="max-w-7xl mx-auto space-y-12">
        <h2 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold tracking-tight leading-[1.12] text-slate-900">
          Who Is This <span className="text-navy-600">Patient Management System For?</span>
        </h2>
