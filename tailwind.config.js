  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        DEFAULT: '0 4px 6px -1px rgba(16, 24, 40, 0.06), 0 2px 4px -2px rgba(16, 24, 40, 0.04)',
        ...
        cardHover: '0 12px 32px -8px rgba(16, 24, 40, 0.12), 0 0 0 1px rgba(16, 24, 40, 0.06)',
        // Glow effects for industrial accents
        glowTeal: '0 0 20px rgba(20, 184, 166, 0.15), 0 4px 16px -4px rgba(20, 184, 166, 0.1)',
        glowNavy: '0 0 32px rgba(37, 77, 200, 0.12), 0 8px 24px -8px rgba(37, 77, 200, 0.1)',
        // Inner shadows
