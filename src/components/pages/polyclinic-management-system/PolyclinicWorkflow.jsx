  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      ...
      <p className="text-base text-gray-500 leading-relaxed mb-10 max-w-4xl">
        Our polyclinic management platform connects multiple specialties, staff, and patients
        through a centralized system for appointments, referrals, billing, and resource management
