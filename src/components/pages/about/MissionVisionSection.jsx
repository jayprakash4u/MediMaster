...
const companyValues = [
  {
    title: "OUR MISSION",
    description: "Our mission is to get regarded as one of the credible names in the IT industry. With our specialization in the field of website & Software Development, we prioritize quality, research and innovation.",
    icon: (
  ...
  {
    title: "OUR VISION",
    description: "Our vision is to go for long by continuously expanding our global reach in different industry verticals where quality, customer satisfaction and innovation will always be among our top priorities.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "OUR GOAL",
    description: "Our core value is to foster a culture of integrity, collaboration, and excellence, ensuring that we deliver innovative solutions while prioritizing our clients' needs and driving sustainable growth.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
