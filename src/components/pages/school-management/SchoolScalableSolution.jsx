    ...
    <section className="bg-white py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-500 text-base leading-relaxed max-w-4xl mb-12">
          Bring school operations into your unique workflow with easy
          admission management, smart attendance, comprehensive grading, and
          smooth parent communication across every touchpoint.
        </p>
