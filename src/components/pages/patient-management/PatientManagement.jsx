...
const features = [
  "Complete patient registration and demographic profiling",
  "Medical history tracking with allergies, conditions, and medications",
  "Appointment scheduling with automated reminders and follow-ups",
  "Integrated billing, insurance, and payment plan management",
];
    ...
    <section className="w-full bg-white py-20 px-4 md:px-8 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-6 space-y-6 max-w-xl">
          ...
          <p className={`${COMPONENT_STYLES.bodyText} ${BODY.base}`}>
            Streamline patient operations with centralized records, smart scheduling,
            and integrated care workflows. Manage every touchpoint—from registration
            to follow-up—with one unified platform.
          </p>
          ...
          <div className="pt-4 space-y-4">
            {features.map((feature, idx) => (
              <div key={idx} className="flex items-start gap-3 group">
                ...
                <p className={`${COMPONENT_STYLES.bodyText} ${BODY.small} md:${BODY.base} leading-snug`}>
                  {feature}
                </p>
              </div>
            ))}
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center w-full">
          ...
          <div className="relative w-full max-w-[540px] aspect-[4/3] rounded-2xl border-4 border-slate-100/80 bg-slate-50 shadow-2xl overflow-hidden group">
            <img
              src="/products/patient mgmnt.jpg"
          ...
          <div className="absolute -bottom-6 -left-4 md:-left-8 bg-white border border-slate-100 rounded-2xl p-4 shadow-xl flex items-center gap-4 max-w-[220px] animate-bounce" style={{ animationDuration: "5s" }}>
            ...
            <div>
              ...
              <p className="text-xxs text-slate-400 font-medium mt-1 leading-tight">Streamlined patient journeys.</p>
            </div>
          </div>
        </div>
      </div>
