...
export default function AccountingOrbit() {
  return (
    <>
      <div
        style={{
      ...
      >
        <div style={{ position: "relative", width: 340, height: 340, overflow: "visible" }}>
          ...
          {[
            { icon: "🧾", lines: ["GST", "Invoice"],         bg: "#047857", angle: 0   },
            { icon: "📑", lines: ["Book-", "Keeping"],        bg: "#0D9488", angle: 45  },
            { icon: "🏦", lines: ["Bank", "Recon"],           bg: "#06B6C4", angle: 90  },
            { icon: "📊", lines: ["Financial", "Reports"],   bg: "#2563EB", angle: 135 },
            { icon: "💳", lines: ["Expense", "Tracking"],    bg: "#14B8A6", angle: 180 },
            { icon: "📈", lines: ["Tax", "Filing"],           bg: "#0891B2", angle: 225 },
            { icon: "👥", lines: ["Multi-User", "Access"],   bg: "#3B66E2", angle: 270 },
            { icon: "🔐", lines: ["Role-Based", "Security"], bg: "#1D4ED8", angle: 315 },
          ].map((mod) => (
            <div
              key={"oc-" + mod.angle}
              style={{
          ...
          {[
            { icon: "💹", lines: ["Cash", "Flow"],             bg: "#14B8A6", angle: 45  },
            { icon: "📋", lines: ["Ledger", "Mgmt"],           bg: "#2563EB", angle: 135 },
            { icon: "🔄", lines: ["Inventory", "Sync"],        bg: "#047857", angle: 225 },
            { icon: "☁️", lines: ["Cloud", "Backup"],          bg: "#3B66E2", angle: 315 },
          ].map((mod) => (
            <div
              key={"ic-" + mod.angle}
              style={{
          ...
          >
            ...
            <div style={{ fontSize: 7, fontWeight: 700, color: "#047857", letterSpacing: "1px", textTransform: "uppercase", marginTop: 4 }}>
              Finance Core
            </div>
          </div>
        </div>
