    ...
    <section className="bg-white py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-500 text-base leading-relaxed max-w-4xl mb-12">
          Bring patient management into your practice workflow with easy registration, smart
          scheduling, comprehensive history tracking, and smooth care coordination across every
          touchpoint.
        </p>
