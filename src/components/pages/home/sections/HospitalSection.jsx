...
const ArrowIcon = () => (
  <svg
    className="w-4 h-4 text-emerald-600 shrink-0 mt-[3px]"
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    strokeWidth="2.5"
    ...
    <section className="w-full bg-white py-16 md:py-24 px-6 sm:px-12 lg:px-16 font-sans">
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-start gap-10 lg:gap-14">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-xxs sm:text-xs font-semibold text-emerald-600 uppercase tracking-widest mb-2">
            Hospital Management
          </p>
          <h2
        ...
        <div className="w-full lg:w-[400px] shrink-0 lg:sticky lg:top-10">
          <div className="rounded-xl overflow-hidden border-2 border-blue-600 bg-slate-50">
            <Image
