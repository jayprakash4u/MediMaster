...
export default function PathologyManagement() {
  const features = [
    ...
    "Automated sample collection tracking from intake to delivery",
    "Integrated barcode labeling for samples with chain-of-custody traceability",
    "Smart result entry with normal range validation and critical value flagging",
  ];
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-6 space-y-6 max-w-xl">
          ...
          <p className="text-slate-500 text-sm md:text-base leading-relaxed">
            The complete pathology lab can be managed by an inbuilt laboratory module.
            You can manage test catalogs, track samples, automate result entry, and generate
            branded reports—much more all structured natively inside a single interface.
          </p>
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center w-full">
          ...
          <div className="relative w-full max-w-[540px] aspect-[4/3] rounded-2xl border-4 border-slate-100/80 bg-slate-50 shadow-2xl overflow-hidden group">
            <img
              src="/pathology/management.jpg"
              alt="Pathology Lab Management Interface"
              className="w-full h-full object-cover object-center group-hover:scale-102 transition-transform duration-500"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/10 via-transparent to-transparent" />
          </div>

          <div className="absolute -bottom-6 -left-4 md:-left-8 bg-white border border-slate-100 rounded-2xl p-4 shadow-xl flex items-center gap-4 max-w-[220px] animate-bounce [animation-duration:5s]">
            ...
            <div>
              <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wider leading-tight">Faster Reporting</h4>
