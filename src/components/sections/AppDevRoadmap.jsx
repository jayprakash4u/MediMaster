...
const leftSteps = [
  { num: "01", title: "Idea & Strategy", desc: "Define app concept, target audience, and core features for maximum impact" },
  { num: "02", title: "Market Research", desc: "Analyze competitors and validate your app idea with real user insights" },
  { num: "03", title: "UI/UX Design", desc: "Create wireframes, prototypes, and stunning interfaces for both iOS and Android" },
  { num: "04", title: "Tech Stack Selection", desc: "Choose the right frameworks and tools for your app's requirements" },
];

const rightSteps = [
  { num: "05", title: "Development", desc: "Build your app using modern technologies and agile development practices" },
  { num: "06", title: "Testing & QA", desc: "Conduct thorough testing across devices to ensure bug-free performance" },
  { num: "07", title: "Launch & Deployment", desc: "Deploy to app stores and set up analytics for tracking performance" },
  { num: "08", title: "Post-Launch Support", desc: "Monitor, update, and scale your app based on user feedback and growth" },
];
...
function StepItem({ step, side, index }) {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 1, x: 0, duration: 0.55, ease: "power3.out", delay: index * 0.08, scrollTrigger: { trigger: el, start: "top 88%", toggleActions: "play none none none" } },
    );
  }, [side, index]);
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-10">
          <div ref={subRef} className="inline-flex items-center gap-2 mb-3">
            <span className="w-7 h-px bg-[#2dd4bf]" /><span className="text-[10px] font-bold tracking-[.28em] text-[#2dd4bf] uppercase">App Development</span><span className="w-7 h-px bg-[#2dd4bf]" />
          </div>
          ...
          <p className="mt-2 text-[10px] font-semibold tracking-[.2em] text-slate-500 uppercase">Mobile App Development Project</p>
        </div>
