...
import { Check, Stethoscope, UserRound, Building2 } from "lucide-react";

const targetPoints = [
  "Independent dental clinics seeking digital practice management",
  "Multi-specialty dental centers handling diverse procedures",
  "Dental chains requiring centralized clinic operations",
  "Individual practitioners wanting to streamline day-to-day operations",
];
...
export default function DentalTargetAudience() {
  const colorMap = {
    teal: {
    ...
    <section className="section-shell w-full bg-white font-sans select-none">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8 lg:space-y-12">
        <h2 className="product-section-title text-slate-900">
          Who Is This <span className="text-navy-600">Dental Clinic Management System For?</span>
        </h2>
