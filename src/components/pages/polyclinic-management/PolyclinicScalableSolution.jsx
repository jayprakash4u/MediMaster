    ...
    <section className="bg-white py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-500 text-base leading-relaxed max-w-4xl mb-12">
          Bring multi-specialty clinic operations into a unified workflow with easy
          appointment booking, centralized patient records, and smooth inter-department
          coordination across every touchpoint.
        </p>
