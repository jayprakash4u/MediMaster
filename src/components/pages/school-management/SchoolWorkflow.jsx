  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      ...
      <p className="text-base text-gray-500 leading-relaxed mb-10 max-w-4xl">
        Our school management platform connects administrators, teachers, students, and
        parents through a centralized system for admissions, attendance, examinations,
