      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-8">
          ...
          <ul className="flex flex-col gap-7">
            {features.map((f) => (
              <li key={f.title} className="flex flex-col gap-1.5">
                <h3 className="text-teal-600 font-semibold text-lg leading-snug">
                  {f.title}
                </h3>
          ...
          <div>
            <a
              href="#demo"
              className="inline-block bg-[#1e4e8c] hover:bg-[#163d70] active:bg-[#0f2d56] text-white text-sm font-bold tracking-widest uppercase px-8 py-4 rounded transition-colors duration-200"
            >
              Book a Free Demo
            </a>
          </div>
