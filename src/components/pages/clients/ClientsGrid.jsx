...
const CLIENTS = [
  { id: 1,  name: "Grande International Hospital", color: "#DC2626", bg: "#FEE2E2", font: "700", size: 12 },
  { id: 2,  name: "Nobel Medical College",        color: "#2563EB", bg: "#EFF6FF", font: "700", size: 13 },
  { id: 3,  name: "Kathmandu Medical College",    color: "#059669", bg: "#ECFDF5", font: "700", size: 13 },
  { id: 4,  name: "Manipal Teaching Hospital",    color: "#7C3AED", bg: "#F5F3FF", font: "700", size: 14 },
  ...
  { id: 9,  name: "Devdaha Medical College",      color: "#7C3AED", bg: "#F5F3FF", font: "700", size: 11 },
  { id: 10, name: "Kathmandu Model Hospital",     color: "#0891B2", bg: "#ECFDF5", font: "700", size: 12 },
  ...
  { id: 14, name: "Norvic International Hospital",color: "#7C3AED", bg: "#F5F3FF", font: "700", size: 10 },
  ...
  { id: 26, name: "Everest Diagnostic Center",    color: "#E11D48", bg: "#FFE4E6", font: "700", size: 10 },
  { id: 27, name: "Nepal Pathology Lab",          color: "#00A651", bg: "#F0FDF4", font: "700", size: 12 },
  { id: 28, name: "Central Diagnostic Center",    color: "#0D47A1", bg: "#E3F2FD", font: "700", size: 9 },
  { id: 29, name: "Kathmandu Medical Labs",       color: "#B91C1C", bg: "#FEE2E2", font: "700", size: 10 },
  ...
  { id: 37, name: "Scheer Memorial Hospital",     color: "#2563EB", bg: "#EFF6FF", font: "700", size: 10 },
  { id: 38, name: "Lumbini Medical College",      color: "#7C3AED", bg: "#F5F3FF", font: "700", size: 10 },
  { id: 39, name: "Pokhara Academy of Health Sciences", color: "#DC2626", bg: "#FEE2E2", font: "700", size: 7 },
  { id: 40, name: "BiratMedical College",         color: "#059669", bg: "#ECFDF5", font: "700", size: 12 },
  { id: 41, name: "Janaki Medical College",       color: "#0891B2", bg: "#ECFDF5", font: "700", size: 11 },
  { id: 42, name: "College of Medical Sciences",  color: "#2563EB", bg: "#EFF6FF", font: "700", size: 9 },
  { id: 43, name: "Om Hospital",                  color: "#7C3AED", bg: "#F5F3FF", font: "700", size: 14 },
  { id: 44, name: "Research Institute of Health Science", color: "#059669", bg: "#ECFDF5", font: "700", size: 7 },
  ...
  { id: 51, name: "Quality Diagnostic Center",    color: "#E11D48", bg: "#FFE4E6", font: "700", size: 9 },
  ...
  { id: 60, name: "Chitwan Medical College",      color: "#2563EB", bg: "#EFF6FF", font: "700", size: 9 },
];
