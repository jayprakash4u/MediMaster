...
const targetPoints = [
  "Hospital pharmacies managing high volume prescriptions",
  "Independent pharmacies seeking digital inventory control",
  "Multi specialty hospitals requiring centralized stock management",
  "Healthcare chains needing integrated pharmacy operations",
];
...
export default function PharmacyTargetAudience() {
  const colorMap = {
    teal: {
    ...
    <section className="section-shell w-full bg-white font-sans select-none">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8 lg:space-y-12">
        <h2 className="product-section-title text-slate-900">
          Who Is This <span className="text-teal-600">Pharmacy Management System For?</span>
        </h2>
