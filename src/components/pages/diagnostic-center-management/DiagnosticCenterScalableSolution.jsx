  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-14">
        ...
        <line x1="32" y1="12" x2="32" y2="20" stroke="#6366f1" strokeWidth="2" strokeLinecap="round"/>
        <line x1="32" y1="44" x2="32" y2="52" stroke="#6366f1" strokeWidth="2" strokeLinecap="round"/>
        <line x1="12" y1="32" x2="20" y2="32" stroke="#6366f1" strokeWidth="2" strokeLinecap="round"/>
        <line x1="44" y1="32" x2="52" y2="32" stroke="#6366f1" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    ...
    <section className="bg-white py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-500 text-base leading-relaxed max-w-4xl mb-12">
          Bring diagnostic center operations into your unique workflow with easy
