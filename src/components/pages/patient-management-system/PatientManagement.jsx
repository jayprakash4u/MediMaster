      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-6 space-y-6 max-w-xl">
          ...
          <p className={`${COMPONENT_STYLES.bodyText} ${BODY.base}`}>
            Streamline patient operations with centralized records, smart scheduling, and integrated
            care workflows. Manage every touchpoint—from registration to follow-up—with one unified
            platform.
          </p>
          ...
          <div className="pt-4 space-y-4">
            {features.map((feature, idx) => (
              <div key={idx} className="flex items-start gap-3 group">
                ...
                <p
                  className={`${COMPONENT_STYLES.bodyText} ${BODY.small} md:${BODY.base} leading-snug`}
                >
                  {feature}
                </p>
              </div>
