        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div className="flex items-center gap-5">
              <Link
                href="/learn-more"
                className="inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-600 text-white text-xs font-semibold px-5 py-2.5 rounded-full transition-colors duration-150"
              >
                Learn more
                <svg
              ...
              <Link
                href="/demo"
                className="text-xs font-semibold text-teal-500 border-b border-teal-200 pb-px hover:text-teal-600 hover:border-teal-400 transition-colors"
              >
                Book a demo
              </Link>
            </div>
