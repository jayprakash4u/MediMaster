...
export default function Navbar() {
  ...
  return (
    <header className="relative w-full font-sans sticky top-0 z-50">
      <div className="h-10 bg-[#0F1F4D] flex items-center overflow-hidden border-b border-teal-900/60">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-xs text-white w-full gap-4">
          ...
          <div className="flex items-center gap-3 text-white text-xs font-medium">
            ...
            <div className="flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zm-7 3a2 2 0 110 4 2 2 0 010-4zm0 14H8s-1 0-1-1c0-2.667 1.333-4 4-4s4 1.333 4 4c0 1-1 1-1 1h-3z" />
              </svg>
              <span className="font-semibold whitespace-nowrap">MediMaster</span>
            </div>
            ...
            <div className="hidden sm:flex items-center gap-1">
              ...
              <span className="whitespace-nowrap">Kathmandu, Bagmati, Nepal</span>
            </div>

            <span className="hidden sm:block text-teal-400/70">|</span>
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <span className="whitespace-nowrap">Ph No - +977-9802109001</span>
            </div>

            <span className="hidden md:block text-teal-400/70">|</span>
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <span className="whitespace-nowrap">Email - info@medimaster.com.np</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 ml-auto shrink-0">
            {/* Facebook */}
            <a href="#" aria-label="Facebook" className="hover:text-teal-300 transition-colors">
            ...
            {/* Instagram */}
            <a href="#" aria-label="Instagram" className="hover:text-teal-300 transition-colors">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* X / Twitter */}
            <a href="#" aria-label="X" className="hover:text-teal-300 transition-colors">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Message / Chat */}
            <a href="#" aria-label="Message" className="hover:text-teal-300 transition-colors">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
