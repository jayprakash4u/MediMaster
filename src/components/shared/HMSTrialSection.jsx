...
export default function HMSTrialSection() {
  ...
  return (
    <section className="relative w-full bg-white py-12 md:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="relative z-10 max-w-5xl mx-auto bg-slate-50 rounded-3xl shadow-2xl overflow-hidden border border-slate-200">
          ...
          <div className="md:col-span-7 p-8 sm:p-10 lg:p-12 flex flex-col justify-center bg-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-3">
                <button
                  type="submit"
                  className="w-full bg-[#07112e] hover:bg-[#0f2050] text-white font-bold text-xs uppercase tracking-widest py-4 rounded-xl shadow-md active:scale-[0.99] transition-all"
                >
                  Get Started
                </button>
              </div>
