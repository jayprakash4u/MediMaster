...
import SchoolOrbit from "@/components/pages/school-management/SchoolOrbit";
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid md:grid-cols-2 items-center gap-12">
        ...
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-[1.12] text-white" style={{ fontFamily: "'Georgia', serif" }}>
            Complete{" "}
            <span className="text-teal-400">School</span> Management Solution
          </h1>
          <p className="text-slate-300 text-lg mb-8 max-w-2xl leading-relaxed">
            Comprehensive school management with student lifecycle tracking, attendance, 
            examinations, grading, fee management, and parent communication. 
            Manage everything with one unified platform.
          </p>
