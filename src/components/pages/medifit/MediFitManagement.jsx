      ...
      <div className="product-intro-grid">
        <div className="lg:col-span-6 space-y-4 max-w-xl sm:space-y-6">
          ...
          <p className="text-slate-500 text-sm md:text-base leading-relaxed">
            Bridge the gap between clinical data and patient wellness through predictive health
            analytics. Manage every touchpoint—from health scoring to personalized care—with one
            unified platform.
          </p>
