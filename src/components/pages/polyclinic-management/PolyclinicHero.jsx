...
import PolyclinicOrbit from "@/components/pages/polyclinic-management/PolyclinicOrbit";
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid md:grid-cols-2 items-center gap-12">
        ...
        <div>
          <span className="inline-block text-teal-400 font-bold text-xs tracking-[0.2em] uppercase mb-4">
            Multi-Specialty Clinic Software
          </span>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-[1.12] text-white" style={{ fontFamily: "'Georgia', serif" }}>
            Complete{" "}
            <span className="text-teal-400">Polyclinic</span> Management Solution
          </h1>
          <p className="text-slate-300 text-lg mb-8 max-w-2xl leading-relaxed">
            Multi-specialty clinic management with centralized patient records, 
            cross-department coordination, and integrated billing. Manage every 
            touchpoint with one unified platform.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link
              href="#polyclinic-trial"
        ...
        {/* Polyclinic Orbit Visualization */}
