...
const leftSteps = [
  { num: "01", title: "Content Brief", desc: "Define objectives, target audience, tone, and content requirements" },
  { num: "02", title: "Research & Outline", desc: "Research topics and create content outlines with key points and structure" },
  { num: "03", title: "Writing Draft", desc: "Create first draft following guidelines, SEO best practices, and brand voice" },
  { num: "04", title: "Internal Review", desc: "Editorial review for grammar, clarity, flow, and adherence to brief" },
];

const rightSteps = [
  { num: "05", title: "Client Review", desc: "Send to client for feedback and incorporate any revisions" },
  { num: "06", title: "Final Edits", desc: "Make final revisions and optimize content for SEO and readability" },
  { num: "07", title: "Delivery", desc: "Deliver final content in required formats with any additional assets" },
  { num: "08", title: "Follow-Up", desc: "Address any final questions and plan ongoing content needs" },
];
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-10">
          <div ref={subRef} className="inline-flex items-center gap-2 mb-3">
            <span className="w-7 h-px bg-[#2dd4bf]" /><span className="text-[10px] font-bold tracking-[.28em] text-[#2dd4bf] uppercase">Content Writing</span><span className="w-7 h-px bg-[#2dd4bf]" />
          </div>
          ...
          <p className="mt-2 text-[10px] font-semibold tracking-[.2em] text-slate-500 uppercase">Content Project</p>
        </div>
