...
export default function DiagnosticCenterTrialSection() {
  ...
  return (
    <section id="diagnostic-center-trial" className="relative w-full bg-slate-900 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-12 min-h-[580px]">
        <div className="md:col-span-5 bg-gradient-to-b from-[#0D9488] to-[#0F766E] p-8 sm:p-10 flex flex-col justify-between text-white">
          <div>
            <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-tight leading-tight mb-6">
              Smart Diagnostic Center Management
            </h2>
            <p className="text-sm text-teal-50/90 leading-relaxed mb-8">
              Streamline your diagnostic operations with intelligent sample tracking,
              automated result entry, and comprehensive reporting. Our system ensures
              accurate diagnostics while minimizing manual errors and turnaround time.
            </p>
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-teal-50">
                ...
                <span>Sample Tracking & Barcoding</span>
              </li>
              <li className="flex items-start gap-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-teal-50">
                <svg className="w-5 h-5 text-teal-200 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
                <span>Automated Result Validation</span>
              </li>
              <li className="flex items-start gap-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-teal-50">
                <svg className="w-5 h-5 text-teal-200 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
                <span>NABL Compliance Reporting</span>
              </li>
            </ul>
          </div>
        ...
        <div className="md:col-span-7 p-8 sm:p-10 lg:p-12 flex flex-col justify-center bg-white">
          <h3 className="text-2xl font-black text-navy-950 uppercase tracking-tight mb-2">
            Try Diagnostic Center Software For Free
          </h3>
          <p className="text-sm text-slate-500 mb-8">
            Start your free trial and experience the full-featured Diagnostic Center Management Software.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input type="text" name="centerName" required placeholder="Center/Institute Name*" value={formData.centerName} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm text-slate-800 placeholder-slate-400 bg-slate-50 focus:outline-none focus:border-teal-500 focus:bg-white transition-all" />
