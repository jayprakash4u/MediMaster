...
const leftSteps = [
  {
    num: "01",
    title: "Idea & Strategy",
    desc: "Define app concept, target audience, and core features for maximum impact",
  },
  {
    num: "02",
    title: "Market Research",
    desc: "Analyze competitors and validate your app idea with real user insights",
  },
  {
    num: "03",
    title: "UI/UX Design",
    desc: "Create wireframes, prototypes, and stunning interfaces for both iOS and Android",
  },
  {
    num: "04",
    title: "Tech Stack Selection",
    desc: "Choose the right frameworks and tools for your app's requirements",
  },
];
...
const rightSteps = [
  {
    num: "05",
    title: "Development",
    desc: "Build your app using modern technologies and agile development practices",
  },
  {
    num: "06",
    title: "Testing & QA",
    desc: "Conduct thorough testing across devices to ensure bug-free performance",
  },
  {
    num: "07",
    title: "Launch & Deployment",
    desc: "Deploy to app stores and set up analytics for tracking performance",
  },
  {
    num: "08",
    title: "Post-Launch Support",
    desc: "Monitor, update, and scale your app based on user feedback and growth",
  },
];

export const APP_DEVELOPMENT_PROCESS = [...leftSteps, ...rightSteps];
...
function StepItem({ step, side, index }) {
  ...
  return (
    <div ref={ref} className="flex items-start gap-2.5 group">
      <div className="shrink-0 w-7 h-7 rounded-full border border-[#2dd4bf]/40 bg-[#2dd4bf]/10 flex items-center justify-center text-xxs sm:text-xs md:text-sm font-black font-mono text-[#2dd4bf] group-hover:bg-[#2dd4bf]/20 group-hover:border-[#2dd4bf]/70 transition-all duration-200 mt-0.5">
        {step.num}
      </div>
      <div>
...
function MobileStepItem({ step, index }) {
  ...
  return (
    ...
    >
      <div className="shrink-0 w-8 h-8 rounded-full bg-[#2dd4bf]/20 border border-[#2dd4bf]/40 flex items-center justify-center text-xs sm:text-sm md:text-base font-black font-mono text-[#2dd4bf]">
        {step.num}
      </div>
      <div>
        <h3 className="text-sm sm:text-base md:text-lg font-bold text-white leading-snug mb-1">
          {step.title}
        </h3>
        <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">{step.desc}</p>
      </div>
...
export default function AppDevRoadmap() {
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-8 md:mb-10">
          ...
          <p className="mt-3 md:mt-4 text-xs sm:text-sm md:text-base text-slate-400 max-w-2xl mx-auto leading-relaxed px-4">
            Our systematic approach to app development ensures quality and results.
          </p>
        </div>
        <div className="flex lg:hidden gap-3 mb-6 px-4">
          <button
            onClick={() => setActiveTab("left")}
            className={`flex-1 py-2.5 px-4 rounded-lg text-xs sm:text-sm md:text-base font-bold transition-all duration-200 ${
              activeTab === "left"
