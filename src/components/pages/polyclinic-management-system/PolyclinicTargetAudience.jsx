...
import { Check, Stethoscope, Network, UserRound } from "lucide-react";

const targetPoints = [
  "Multi-specialty clinics managing diverse patient panels",
  "Independent clinics seeking integrated digital operations",
  "Clinic chains requiring centralized management",
  "Healthcare facilities wanting to streamline referrals and billing",
];
...
export default function PolyclinicTargetAudience() {
  const colorMap = {
    teal: {
    ...
    <section className="w-full bg-white py-16 px-6 md:px-12 font-sans select-none">
      <div className="max-w-7xl mx-auto space-y-12">
        <h2 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold tracking-tight leading-[1.12] text-slate-900">
          Who Is This <span className="text-navy-600">Polyclinic Management System For?</span>
        </h2>
