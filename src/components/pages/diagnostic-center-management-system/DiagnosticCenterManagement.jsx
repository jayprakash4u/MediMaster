      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-6 space-y-6 max-w-xl">
          ...
          <p className="text-slate-500 text-sm md:text-base leading-relaxed">
            The complete diagnostic center can be managed by an inbuilt module. You can manage test
            catalogs, track samples, automate result entry, and generate branded reports—all
            structured natively inside a single interface.
          </p>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xxs text-slate-400 font-medium mt-1 leading-tight">
                Automated result entry & validation.
              </p>
            </div>
          </div>
        </div>
