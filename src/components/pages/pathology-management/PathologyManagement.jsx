      ...
      <div className="product-intro-grid">
        <div className="lg:col-span-6 space-y-4 max-w-xl sm:space-y-6">
          ...
          <p className="text-slate-500 text-sm md:text-base leading-relaxed">
            The complete pathology lab can be managed by an inbuilt laboratory module. You can
            manage test catalogs, track samples, automate result entry, and generate branded
            reports—much more all structured natively inside a single interface.
          </p>
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center w-full pb-6 sm:pb-0">
          ...
          <div className="relative mx-auto mt-4 max-w-[220px] sm:absolute sm:-bottom-6 sm:-left-4 sm:mx-0 sm:mt-0 md:-left-8 bg-white border border-slate-100 rounded-2xl p-4 shadow-xl flex items-center gap-4 max-w-[220px] animate-bounce [animation-duration:5s]">
