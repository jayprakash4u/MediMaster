...
export default function DiagnosticCenterOrbit() {
  return (
    <>
      <div
      ...
      >
        <div style={{ position: "relative", width: 340, height: 340, overflow: "visible" }}>
          ...
          {[
            { icon: "🧪", lines: ["Test", "Catalog"], bg: "#0D9488", angle: 0 },
            { icon: "🏷️", lines: ["Barcode", "Tracking"], bg: "#06B6D4", angle: 45 },
            { icon: "📊", lines: ["Report", "Generation"], bg: "#3B66E2", angle: 90 },
            { icon: "🩻", lines: ["Imaging", "Integration"], bg: "#254DC8", angle: 135 },
            { icon: "💳", lines: ["Billing &", "Insurance"], bg: "#14B8A6", angle: 180 },
            { icon: "🔔", lines: ["Critical", "Alerts"], bg: "#0891B2", angle: 225 },
            { icon: "📈", lines: ["NABL", "Compliance"], bg: "#3B66E2", angle: 270 },
            { icon: "🏥", lines: ["Multi-Branch", "Sync"], bg: "#254DC8", angle: 315 },
          ].map((mod) => (
            <div
              key={"oc-" + mod.angle}
              style={{
          ...
          {[
            { icon: "🔬", lines: ["Analyzer", "Interface"], bg: "#14B8A6", angle: 45 },
            { icon: "🛡️", lines: ["QC &", "NABL"], bg: "#254DC8", angle: 135 },
            { icon: "📋", lines: ["Sample", "Tracking"], bg: "#0D9488", angle: 225 },
            { icon: "📱", lines: ["Patient", "Portal"], bg: "#3B66E2", angle: 315 },
          ].map((mod) => (
            <div
              key={"ic-" + mod.angle}
              style={{
