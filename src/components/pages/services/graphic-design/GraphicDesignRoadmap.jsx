...
const leftSteps = [
  { num: "01", title: "Brief & Discovery", desc: "Understand your brand, objectives, target audience, and design requirements" },
  { num: "02", title: "Research & Inspiration", desc: "Study competitor designs, gather inspiration, and define visual direction" },
  { num: "03", title: "Concept Development", desc: "Create initial concepts, mood boards, and design exploration" },
  { num: "04", title: "Design Refinement", desc: "Refine chosen concepts based on feedback and create polished designs" },
];

const rightSteps = [
  { num: "05", title: "Revisions & Feedback", desc: "Incorporate feedback and make necessary adjustments to designs" },
  { num: "06", title: "Final Production", desc: "Prepare final files in all required formats for print and digital use" },
  { num: "07", title: "Delivery & Handoff", desc: "Provide all source files, guidelines, and brand assets" },
  { num: "08", title: "Post-Delivery Support", desc: "Make minor adjustments and provide ongoing design support" },
];
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-10">
          <div ref={subRef} className="inline-flex items-center gap-2 mb-3">
            <span className="w-7 h-px bg-[#2dd4bf]" /><span className="text-[10px] font-bold tracking-[.28em] text-[#2dd4bf] uppercase">Graphic Design</span><span className="w-7 h-px bg-[#2dd4bf]" />
          </div>
          ...
          <p className="mt-2 text-[10px] font-semibold tracking-[.2em] text-slate-500 uppercase">Design Project</p>
        </div>
