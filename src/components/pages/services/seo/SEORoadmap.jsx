...
const leftSteps = [
  {
    ...
    desc: "Comprehensive audit of your website's current SEO performance and technical health",
  },
  {
    num: "02",
    title: "Keyword Research",
    desc: "Identify high-value keywords and search opportunities for your target audience",
  },
  {
    num: "03",
    title: "On-Page Optimization",
    desc: "Optimize meta tags, content, URLs, and technical elements for search engines",
  },
  {
    num: "04",
    title: "Content Strategy",
    desc: "Develop quality content plan aligned with keyword targets and user intent",
  },
];
...
const rightSteps = [
  {
    num: "05",
    title: "Link Building",
    desc: "Build authoritative backlinks from reputable sites to boost domain authority",
  },
  {
    num: "06",
    title: "Technical SEO",
    desc: "Improve site speed, mobile experience, and fix crawl errors",
  },
  {
    num: "07",
    title: "Tracking Setup",
    desc: "Configure analytics and monitoring tools to track ranking improvements",
  },
  {
    num: "08",
    title: "Ongoing Optimization",
    desc: "Continuous refinement based on performance data and algorithm updates",
  },
];

export const SEO_PROCESS = [...leftSteps, ...rightSteps];
