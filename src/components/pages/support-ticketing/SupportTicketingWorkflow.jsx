...
export default function SupportTicketingWorkflow() {
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      <h2
        className="text-3xl sm:text-4xl lg:text-4xl font-extrabold tracking-tight leading-[1.12] text-slate-900 mb-2"
      ...
      <p className="text-base text-gray-500 leading-relaxed mb-10 max-w-4xl">
        Our support ticketing platform connects customers, support agents, and managers through a
        centralized system for ticket management, routing, resolution, and continuous improvement.
      </p>
