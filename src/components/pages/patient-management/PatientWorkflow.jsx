...
import { CalendarCheck, Stethoscope, ClipboardList, FileText, Receipt, Package } from "lucide-react";
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      ...
      <p className="text-base text-gray-500 leading-relaxed mb-10 max-w-4xl">
        Our patient management platform connects front desk, clinical staff, and billing
        teams through a centralized system for registration, appointments, care
