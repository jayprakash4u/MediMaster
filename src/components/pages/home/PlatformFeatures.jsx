  ...
  return (
    <section className="bg-slate-50 py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Subheading */}
        <p className="text-center text-gray-500 text-[15px] max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-12">
          {tabs.map((tab, i) => (
            <button
              ...
              className={`px-5 py-2 rounded-full text-[14px] font-medium border transition-all duration-200 ${
                activeTab === i
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* Badge */}
            <span className="inline-flex items-center gap-2 text-teal-600 text-[13px] font-semibold tracking-wide">
            ...
            <div className="mt-2">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-teal-700 hover:bg-teal-800 text-white text-[14px] font-semibold px-6 py-3 rounded-full transition-colors duration-200"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
