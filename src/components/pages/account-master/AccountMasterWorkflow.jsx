...
export default function AccountMasterWorkflow() {
  return (
    <ProductWorkflowSection
      title="Streamline your Account Master workflow"
      description="Our Account Master platform connects finance, operations, and compliance teams through a centralized system for invoicing, reconciliation, reporting, and statutory filings across all departments."
      steps={steps}
    />
  );
}
