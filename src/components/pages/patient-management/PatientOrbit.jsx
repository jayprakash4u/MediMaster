...
export default function PatientOrbit() {
  return (
    <>
      <div
        style={{
      ...
      >
        <div style={{ position: "relative", width: 340, height: 340, overflow: "visible" }}>
          ...
          {[
            ...
            { icon: "🏥", lines: ["Medical", "History"],        bg: "#3B66E2", angle: 90  },
            { icon: "💳", lines: ["Billing &", "Insurance"],   bg: "#254DC8", angle: 135 },
            { icon: "💊", lines: ["Medication", "Tracking"],   bg: "#14B8A6", angle: 180 },
            { icon: "📊", lines: ["Health", "Analytics"],      bg: "#0891B2", angle: 225 },
            { icon: "📱", lines: ["Patient", "Portal"],        bg: "#3B66E2", angle: 270 },
            { icon: "🔔", lines: ["Reminders &", "Follow-ups"],bg: "#254DC8", angle: 315 },
          ].map((mod) => (
            <div
              key={"oc-" + mod.angle}
              style={{
          ...
          {[
            { icon: "🩺", lines: ["Clinical", "Notes"],       bg: "#14B8A6", angle: 45  },
            { icon: "🛡️", lines: ["Data", "Privacy"],         bg: "#254DC8", angle: 135 },
            { icon: "📈", lines: ["Progress", "Tracking"],    bg: "#0D9488", angle: 225 },
            { icon: "🔗", lines: ["HIS / EMR", "Sync"],       bg: "#3B66E2", angle: 315 },
          ].map((mod) => (
            <div
              key={"ic-" + mod.angle}
              style={{
