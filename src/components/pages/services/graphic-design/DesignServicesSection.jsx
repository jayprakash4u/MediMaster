...
function DesignCard({ item, index }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-40 sm:h-44 md:h-48 lg:h-52 bg-slate-50 border-b border-slate-200 flex items-center justify-center overflow-hidden">
        {item.image ? (
          <Image
            src={item.image}
            alt={item.category}
          ...
          <div className="flex flex-col items-center gap-2 text-slate-400">
            ...
            <span className="text-xs sm:text-sm text-slate-400 font-medium tracking-wider uppercase">
              Image coming soon
            </span>
          </div>
        )}
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p
              className={`text-xxs sm:text-xs md:text-sm font-bold tracking-[0.2em] uppercase mb-0.5 ${c.tag}`}
            >
        ...
        <ul className="space-y-2 flex-1">
          {item.features.map((f, i) => (
            <li key={i} className="flex items-start gap-2.5">
              <span
                className={`mt-[5px] w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full shrink-0 ${c.bullet}`}
              />
        ...
        <div className="pt-3 border-t border-slate-200">
          <p className="text-xxs sm:text-xs md:text-sm text-slate-500 uppercase tracking-widest font-semibold mb-1">
            Deliverables
          </p>
          <p className="text-xs sm:text-sm text-slate-500 italic">{item.examples}</p>
        </div>
      </div>
    </div>
  );
...
DesignServicesSection.propTypes = {};
...
export default function DesignServicesSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-white py-14 sm:py-16 md:py-20 lg:py-24 overflow-hidden"
    >
      <div
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14 max-w-2xl mx-auto">
          <div ref={subheadRef} className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-xs sm:text-sm md:text-base font-bold tracking-[0.2em] uppercase text-teal-600">
          ...
          <h2
            ref={headerRef}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.12] text-slate-900"
          >
            Design Services <span className="text-teal-600">We Offer</span>
          </h2>
          ...
          >
            From comprehensive brand design architectures to production-grade 3D renders — we
            engineer impactful visual content built to elevate corporate communication.
          </p>
        </div>
