  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      ...
      <p className="text-base text-gray-500 leading-relaxed mb-10 max-w-4xl">
        LinkHMS connects lab technicians, pathologists, and clinicians through a centralized
        solution for sample management, test processing, and result reporting. It ensures accuracy
        and efficiency across all diagnostic operations.
      </p>
