    ...
    <section className="w-full bg-white py-16 md:py-24 px-6 sm:px-12 lg:px-16 font-sans">
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row-reverse items-start gap-10 lg:gap-14">
        ...
        <div className="flex-1 min-w-0">
          ...
          <ul className="m-0 p-0 list-none grid grid-cols-2 gap-x-6 gap-y-1 mt-8">
            {allItems.map((item, i) => (
          ...
          <button className="inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 border border-indigo-600 rounded-full px-5 py-2 hover:bg-indigo-50 transition-colors mt-6">
            Learn more
            <svg
              className="w-4 h-4"
              viewBox="0 0 24 24"
