...
export default function SupportTicketingOrbit() {
  return (
    <>
      <div
      ...
      >
        <div style={{ position: "relative", width: 340, height: 340, overflow: "visible" }}>
          ...
          {[
            { icon: "🎫", lines: ["Ticket", "Creation"], bg: "#0D9488", angle: 0 },
            { icon: "📧", lines: ["Multi-Channel", "Inbox"], bg: "#06B6D4", angle: 45 },
            { icon: "🤖", lines: ["Automated", "Routing"], bg: "#3B66E2", angle: 90 },
            { icon: "⏱️", lines: ["SLA", "Tracking"], bg: "#254DC8", angle: 135 },
            { icon: "📊", lines: ["Performance", "Dashboards"], bg: "#14B8A6", angle: 180 },
            { icon: "🔔", lines: ["Real-Time", "Alerts"], bg: "#0891B2", angle: 225 },
            { icon: "📚", lines: ["Knowledge", "Base"], bg: "#3B66E2", angle: 270 },
            { icon: "😊", lines: ["CSAT &", "Surveys"], bg: "#254DC8", angle: 315 },
          ].map((mod) => (
            <div
              key={"oc-" + mod.angle}
              style={{
          ...
          {[
            { icon: "📋", lines: ["Ticket", "Templates"], bg: "#14B8A6", angle: 45 },
            { icon: "🏷️", lines: ["Priority", "Levels"], bg: "#254DC8", angle: 135 },
            { icon: "👥", lines: ["Agent", "Assignment"], bg: "#0D9488", angle: 225 },
            { icon: "📈", lines: ["Resolution", "Metrics"], bg: "#3B66E2", angle: 315 },
          ].map((mod) => (
            <div
              key={"ic-" + mod.angle}
              style={{
