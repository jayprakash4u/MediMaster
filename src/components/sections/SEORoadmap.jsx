...
const leftSteps = [
  { num: "01", title: "Audit & Analysis", desc: "Comprehensive audit of your website's current SEO performance and technical health" },
  { num: "02", title: "Keyword Research", desc: "Identify high-value keywords and search opportunities for your target audience" },
  { num: "03", title: "On-Page Optimization", desc: "Optimize meta tags, content, URLs, and technical elements for search engines" },
  { num: "04", title: "Content Strategy", desc: "Develop quality content plan aligned with keyword targets and user intent" },
];

const rightSteps = [
  { num: "05", title: "Link Building", desc: "Build authoritative backlinks from reputable sites to boost domain authority" },
  { num: "06", title: "Technical SEO", desc: "Improve site speed, mobile experience, and fix crawl errors" },
  { num: "07", title: "Tracking Setup", desc: "Configure analytics and monitoring tools to track ranking improvements" },
  { num: "08", title: "Ongoing Optimization", desc: "Continuous refinement based on performance data and algorithm updates" },
];
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-10">
          <div ref={subRef} className="inline-flex items-center gap-2 mb-3">
            <span className="w-7 h-px bg-[#2dd4bf]" /><span className="text-[10px] font-bold tracking-[.28em] text-[#2dd4bf] uppercase">SEO Services</span><span className="w-7 h-px bg-[#2dd4bf]" />
          </div>
          ...
          <p className="mt-2 text-[10px] font-semibold tracking-[.2em] text-slate-500 uppercase">Search Engine Optimization Project</p>
        </div>
