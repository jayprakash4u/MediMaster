...
const ColorSystemDemo = () => {
  ...
  const ColorSwatch = ({ color }) => (
    <div className="relative group">
      ...
      <div className="mt-2">
        ...
        {color.desc && <div className="text-xxs text-gray-400 mt-0.5">{color.desc}</div>}
      </div>
    </div>
  );
  ...
  const ButtonDemo = ({ variant, children, className = "" }) => {
    const variants = {
      ...
      secondary:
        "bg-deepNavy-600 hover:bg-deepNavy-700 text-white shadow-lg shadow-deepNavy-600/25",
    ...
    return (
      <button
        className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-200 ${variants[variant]} ${className}`}
      >
        {children}
      </button>
    );
  ...
  ButtonDemo.propTypes = {
    variant: PropTypes.oneOf(["primary", "secondary", "accent", "outline", "ghost"]).isRequired,
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Professional color palette built for enterprise applications. PrimaryTeal/Aqua for
            interactions, Deep Navy for branding, Neutral tones for surfaces.
          </p>
        </div>
        ...
        <section className="space-y-6">
          ...
          <p className="text-slate-600">
            Buttons, Labels, Accents - Interactive elements that guide user actions
          </p>
        ...
        <section className="space-y-6">
          ...
          <p className="text-slate-600">
            Logo, Typography, Illustration - Core brand identity elements
          </p>
          ...
          <CardDemo title="Typography System">
            <div className="space-y-4">
              <div>
                <h1 className="text-5xl font-bold text-deepNavy-900 leading-tight">
                  Display Heading
                </h1>
                <p className="text-slate-500 mt-2">
                  font-weight: 800 | line-height: 1.1 | Tracking: -0.02em
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                <p className="text-base text-slate-600 leading-relaxed">
                  Body text maintains excellent readability with sufficient contrast ratio. Line
                  height ensures comfortable reading across all screen sizes.
                </p>
        ...
        <section className="space-y-6">
          ...
          <p className="text-slate-600">
            Input fields, Card shadows - Structural and depth elements
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="text-sm text-slate-600">
                  Cards use subtle shadows to create depth hierarchy. Borders use gray-300 for clear
                  separation.
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-600 ml-6">
                  Use teal-500 for primary buttons, links, and key interactions. Reserved for most
                  important actions.
                </p>
              </div>
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-600 ml-6">
                  Deep navy for logos, headings, and navigation. Projects authority and trust.
                </p>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-slate-600 ml-6">
                  Aqua for secondary actions, badges, and visual highlights. Adds energy without
                  overwhelming.
                </p>
              </div>
              <div className="space-y-3">
                ...
                <p className="text-sm text-slate-600 ml-6">
                  White/off-white for cards and modals. Subtle shadows create depth and hierarchy.
                </p>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-slate-600 ml-6">
                  Light gray for page backgrounds. Reduces eye strain while maintaining cleanliness.
                </p>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-slate-600 ml-6">
                  Dark gray for text. High contrast for readability without harsh black-on-white.
                </p>
              </div>
            </div>
          </CardDemo>
