...
const leftSteps = [
  {
    num: "01",
    title: "Content Brief",
    desc: "Define objectives, target audience, tone, and content requirements",
  },
  {
    num: "02",
    title: "Research & Outline",
    desc: "Research topics and create content outlines with key points and structure",
  },
  {
    num: "03",
    title: "Writing Draft",
    desc: "Create first draft following guidelines, SEO best practices, and brand voice",
  },
  {
    num: "04",
    title: "Internal Review",
    desc: "Editorial review for grammar, clarity, flow, and adherence to brief",
  },
];
...
const rightSteps = [
  {
    num: "05",
    title: "Client Review",
    desc: "Send to client for feedback and incorporate any revisions",
  },
  {
    num: "06",
    title: "Final Edits",
    desc: "Make final revisions and optimize content for SEO and readability",
  },
  {
    num: "07",
    title: "Delivery",
    desc: "Deliver final content in required formats with any additional assets",
  },
  {
    num: "08",
    title: "Follow-Up",
    desc: "Address any final questions and plan ongoing content needs",
  },
];

export const CONTENT_WRITING_PROCESS = [...leftSteps, ...rightSteps];
...
function ModuleWheel({ steps }) {
  ...
  return (
    <svg
      ...
      height="210"
      viewBox="0 0 210 210"
      className="shrink-0 w-[180px] h-[180px] sm:w-[210px] sm:h-[210px]"
      aria-hidden="true"
    >
      <circle
        cx="105"
...
export default function ContentWritingRoadmap() {
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Our systematic approach to content writing ensures quality and results.
          </p>
        </div>

        <div className="md:hidden mb-6">
          <div className="flex gap-2 p-1.5 rounded-full bg-slate-800/50 border border-slate-700 w-fit mx-auto">
            <button
              onClick={() => setActiveTab("left")}
              className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${activeTab === "left" ? "bg-teal-400 text-slate-950" : "text-slate-400 hover:text-white"}`}
            >
              Steps 1-4
            </button>
            <button
              onClick={() => setActiveTab("right")}
              className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${activeTab === "right" ? "bg-teal-400 text-slate-950" : "text-slate-400 hover:text-white"}`}
            >
              Steps 5-8
            </button>
          </div>
