...
export default function SupportTicketingBenefitsSection() {
  const benefits = [
    "Reduces ticket resolution time with automated routing and escalation",
    "Improves customer satisfaction with faster response times",
    "Provides comprehensive analytics on support team performance",
    "Ensures SLA compliance with real-time tracking and alerts",
    "Centralizes support knowledge for consistent customer responses",
    "Minimizes manual effort with smart ticket categorization",
    "Enables multi-channel support from a single unified inbox",
  ];
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-8 items-center relative z-10">
        ...
        <div className="order-1 lg:order-none lg:col-span-7 flex flex-col justify-center text-left">
          <h2 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold tracking-tight leading-[1.12] text-white mb-8">
            ...
            <span className="text-teal-600">Ticketing System</span>
          </h2>
