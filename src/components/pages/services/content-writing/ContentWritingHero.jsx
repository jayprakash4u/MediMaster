          ...
          <div ref={contentRef} className="flex-1 max-w-2xl text-center lg:text-left">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base leading-relaxed text-slate-300 max-w-xl">
                Engage your audience with compelling, high-quality content that drives results. From
                blog posts and web copy to technical documentation and marketing materials, our
                expert writers craft content that converts readers into customers.
              </p>
            </div>
          ...
          <div ref={imageRef} className="flex-1 flex justify-center lg:justify-end">
            ...
            >
              ...
              {floatingIcons.map((icon, i) => (
                <div key={icon.name} className="hidden md:block">
