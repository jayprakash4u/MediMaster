...
const PACKAGES = [
  {
    ...
    description:
      "A full suite of hospital management modules covering every department — from admissions and billing to finance, inventory and campaigns.",
    stats: [
    ...
    sideNote: {
      ...
      body: "Centralised workflows mean every department — OPD, IPD, pharmacy, lab, and finance — operates from a single connected system with real-time visibility.",
    },
    reverse: false,
  },
  {
    ...
    description:
      "Purpose-built for diagnostic labs — from sample collection and test tracking through to outsourcing, analysis and controlled report printing.",
    stats: [
  ...
  },
  {
    ...
    description:
      "From purchase orders and supplier management to real-time stock analysis — complete visibility across every product, category and department.",
    stats: [
    ...
    sideNote: {
      ...
      body: "Track every product from purchase to dispensing with automated reorder alerts, supplier ledgers, and department-wise stock allocation — all in one dashboard.",
    },
    reverse: false,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div ref={headerRef} className="pt-20 pb-14 text-center max-w-2xl mx-auto">
          ...
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
            ...
            operations — monthly, quarterly, semi-annual, and annual.
          </p>
