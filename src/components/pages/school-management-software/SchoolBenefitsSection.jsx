...
export default function SchoolBenefitsSection() {
  const benefits = [
    "Streamlines school operations with centralized student and staff management",
    "Reduces administrative burden with automated attendance and grading",
    "Improves parent engagement with real-time communication and portals",
    "Ensures accurate fee collection with automated billing and receipts",
    "Provides real-time visibility into school performance and analytics",
    "Minimizes manual data entry errors with integrated digital records",
    "Supports multi-campus operations with centralized data management",
  ];
    ...
    <section className="relative w-full bg-navy-950 text-white overflow-hidden py-20 px-6 sm:px-12 lg:px-20">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
            ...
            <div className="relative w-[85%] z-20 transform hover:-translate-y-2 transition-transform duration-500 ease-out">
              <div className="bg-slate-900 p-2 pb-3 rounded-t-2xl shadow-2xl border border-slate-700/50">
                <div className="relative aspect-[16/10] bg-white rounded-lg overflow-hidden border border-slate-800">
                  <Image
                    src="/products/schoolmgmnt2.jpg"
                    alt="School Management Benefits"
                    fill
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-left">
          <h2 className={`${HEADING.h2} mb-8 text-white`}>
          ...
          <ul className="space-y-4 max-w-2xl">
            {benefits.map((text, idx) => (
              <li key={idx} className="flex items-start gap-3.5 group">
                ...
                <p
                  className={`${COMPONENT_STYLES.bodyLarge} group-hover:text-white transition-colors duration-200`}
                >
                  {text}
                </p>
              </li>
