...
export default function DiagnosticCenterWorkflow() {
  return (
    <ProductWorkflowSection
      title="Streamline your diagnostic center workflow"
      description="Connect diagnostic center staff, pathologists, and clinicians through a centralized solution for sample management, test processing, and result reporting. It ensures accuracy and efficiency across all diagnostic operations."
      steps={steps}
    />
  );
}
