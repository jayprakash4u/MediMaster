      ...
      <div className="product-intro-grid">
        <div className="lg:col-span-6 space-y-4 max-w-xl sm:space-y-6">
          ...
          <p className="text-slate-500 text-sm md:text-base leading-relaxed">
            The complete polyclinic can be managed by an inbuilt module. You can manage
            multi-specialty appointments, coordinate departments, and streamline operations—all
          ...
          >
            ...
            <div>
              ...
              <p className="text-xxs text-slate-400 font-medium mt-1 leading-tight">
                Multi-specialty coordination simplified.
              </p>
            </div>
          </div>
        </div>
