...
export default function PMSStatic() {
  return (
    <>
      <div
        style={{
      ...
      >
        ...
        <div style={{ position: "relative", width: 340, height: 340, overflow: "visible" }}>
          ...
          >
            ...
            <div style={{ fontSize: 24, fontWeight: 900, color: "#fff", letterSpacing: -1, lineHeight: 1 }}>PMS</div>
            <div style={{ fontSize: 7, fontWeight: 700, color: "#0D9488", letterSpacing: "1.2px", textTransform: "uppercase", marginTop: 2 }}>
              Pharma Core
            </div>
          </div>
        </div>
