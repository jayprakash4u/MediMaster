...
const uiuxTypes = [
  {
    ...
    color: "teal",
    image: "/ui ux/mobile app design.jpg",
    features: [
  ...
  },
  {
    ...
    color: "navy",
    image: "/ui ux/Accessibility Design.jpg",
    features: [
      "WCAG compliance",
